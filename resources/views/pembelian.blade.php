                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <h1 class="card-title">Add Pembelian</h1>
                            <form class="form-inline" action="{{ route('pembelian.store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="nomor_pembelian" class="form-label">Nomor Pembelian</label>
                                    <input type="text" class="form-control" id="nomor_pembelian"
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-title">Data Pembelian</p>
